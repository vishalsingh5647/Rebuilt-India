...
const Tech = () => {
  return (
    <div>
      ...
      {/* Breadcrumb Section */}
      <section className="bg-white border-t-2 border-red-600">
                ...
                <div className="p-3">
                  <div className="flex items-center">
                    ...
                    <button className="bg-red-600 hover:bg-red-700 text-white px-3 py-2 rounded-r">
                      {/* simple magnifier via CSS since lucide is not imported here */}
                      <span className="block w-3 h-3 border-2 border-white rounded-full mr-1" />
                    </button>
                  </div>
                </div>
              </div>
