...
// Left grid layout (matches Tech/Travel)
...
const gridItems = [
  ...
  },
  {
    ...
    date: 'Jan 15, 2019',
    author: 'Theme Horse',
    img: 'https://images.unsplash.com/photo-1526404803658-8b6a5c1c6c3a?q=80&w=800&auto=format&fit=crop',
    excerpt: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam eros ante, placerat ac pulvinar at, iaculis a quam...'
  },
  {
...
const CategoriesPanel = ({ current = 'Health' }) => {
  const cats = [
      ...
      <section className="bg-white border-t-2 border-red-600 animate-fadeDown">
        <div className="container mx-auto px-4 py-3 text-sm">
          <nav className="flex items-center gap-2 text-gray-600" aria-label="Breadcrumb">
            ...
            <span className="text-gray-400">/</span>
            <span className="text-gray-800 font-semibold">Health</span>
          </nav>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            <div className="md:col-span-8">
              <h2 className="text-xl font-semibold text-gray-900 mb-3">Category: Health</h2>
            ...
            <div className="md:col-span-4 space-y-4">
              ...
              <CategoriesPanel current="Health" />
            </div>
          </div>
        </div>
      </section>
